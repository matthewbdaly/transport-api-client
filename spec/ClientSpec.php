...
class ClientSpec extends ObjectBehavior
{
    ...
    function it_can_get_train_departures(HttpClient $client, MessageFactory $messageFactory, RequestInterface $request, ResponseInterface $response)
    {
        $appId = "Foo";
        $key = "Bar";
        $this->beConstructedWith($appId, $key, $client, $messageFactory);
        ...
        $this->getTrainDepartures('NRW', 'LST')->shouldReturn($response);
    }
}
